  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] relative">
      ...
      >
        ...
        <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="space-y-4">
           ...
           <div className="space-y-0.5">
              <span className="text-[12px] font-bold tracking-[0.5em] text-teal-600/60 uppercase">PHÚC ANH</span>
      ...
      <footer className="fixed bottom-6 right-6 z-50">
        ...
        >
          <p className="text-[12px] font-black text-slate-900 tracking-wide">Nguyễn Thị Lan Anh</p>
          <p className="text-[10px] font-bold text-teal-600/80 uppercase tracking-[0.15em]">GVHD: NCS. Trần Thị Hương</p>
        </motion.div>
      </footer>
    </div>
  );
