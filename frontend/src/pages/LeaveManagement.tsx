  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <form
          onSubmit={handleSave}
          className="border p-6 rounded-xl bg-card space-y-4 shadow-sm h-fit"
        >
            ...
            <select
              ...
              onChange={(e) => {
                ...
                setNewLeave({
                  ...
                  endDate: end,
                  employee: { id: "" },
                }); // Reset nhân viên khi đổi loại nghỉ để đảm bảo lọc đúng
              }}
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              onChange={(e) =>
                setNewLeave({ ...newLeave, employee: { id: e.target.value } })
              }
              className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              required
            >
          ...
          <div className="flex gap-2">
            <Button
              type="submit"
              className={`flex-1 ${editingId !== null ? "bg-amber-600 hover:bg-amber-700" : ""}`}
            >
        ...
        <div className="col-span-2 border rounded-xl bg-card shadow-sm overflow-hidden">
          {/* ==============================================
              KHU VỰC VẼ BẢNG: QUẢN LÝ NGHỈ PHÉP & NGHỈ CHẾ ĐỘ
              ============================================== */}
          <table className="w-full text-sm text-left">
            ...
            <tbody className="divide-y">
              {leaves.map((l) => (
                <tr
                  key={l.id}
                  className={`hover:bg-muted/30 transition-colors ${editingId === l.id ? "bg-amber-50 ring-1 ring-amber-200" : ""}`}
                >
                  ...
                  <td className="p-4">
                    ...
                    >
                      {l.leaveType === "ANNUAL" ? "Phép năm" : "Thai sản"}
                    </span>
                  </td>
