          ...
          <div className="space-y-8">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              <div className="space-y-2">
                <label className="text-lg font-medium text-gray-400 ml-1">
                  Tên đăng nhập
                </label>
                <div className="relative group">
                  <User
                    className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-300 group-focus-within:text-blue-600 transition-colors"
                    size={20}
                  />
                  <input
                    type="text"
              ...
              <div className="flex items-center text-lg">
                <label className="flex items-center gap-2 cursor-pointer group">
                  ...
                  />
                  <span className="text-gray-400 group-hover:text-gray-700 transition-colors font-medium">
                    Ghi nhớ đăng nhập
                  </span>
                </label>
              </div>
