...
export default function SystemParamsPage() {
  ...
  useEffect(() => {
    {
      /* ==============================================
        KHU VỰC GỌI API: LẤY DỮ LIỆU TỪ BACKEND
        (Thường được đặt trong useEffect để chạy ngay khi component render)
        ============================================== */
    }
    axios
    ...
    <div className="max-w-4xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      ...
      <div className="flex flex-col items-center text-center gap-2">
        ...
        <h1 className="text-4xl font-black tracking-tighter text-slate-800 uppercase">
          Tham số <span className="text-primary italic">Hệ thống</span>
        </h1>
        <p className="text-muted-foreground font-medium text-sm max-w-md">
          Thiết lập các hằng số cơ bản dùng trong tính toán lương và phúc lợi
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          {
            label: "Số công chuẩn",
            value: `${params.standardWorkDays} ngày`,
            icon: Calendar,
            color: "text-blue-500",
            bg: "bg-blue-50",
          },
          {
            ...
            value:
              new Intl.NumberFormat("vi-VN").format(params.minimumWage) + " đ",
            icon: Coins,
          ...
          },
          {
            label: "Ăn ca / Ngày",
            value:
              new Intl.NumberFormat("vi-VN").format(params.mealAllowance) +
              " đ",
            icon: Utensils,
          ...
          <div
            key={i}
            className="bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50 flex flex-col gap-4 items-center text-center"
          >
            <div
            ...
            <div>
              ...
              <h4 className={`text-xl font-black tracking-tight ${s.color}`}>
                {s.value}
              </h4>
            </div>
          </div>
        ...
        <div className="p-10 space-y-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
            ...
            <div className="flex flex-col justify-end pb-1">
              <div className="p-5 bg-blue-50 border border-blue-100 rounded-2.5xl flex items-start gap-4">
                ...
                <div>
                  <h5 className="text-[10px] font-black text-blue-900 uppercase tracking-widest mb-1">
                    Xác thực hệ thống
                  </h5>
                  <p className="text-[9px] text-blue-600/80 font-bold leading-tight">
                    Các thay đổi sẽ ảnh hưởng trực tiếp đến kết quả tính lương
                    của toàn bộ nhân viên trong kỳ.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="pt-6 border-t border-slate-50 flex justify-center">
            ...
            >
              <Save
                size={18}
                className="mr-3 group-hover:scale-125 transition-all"
              />{" "}
