    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      ...
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted-foreground font-medium text-sm">
          Cấu hình biểu thuế lũy tiến và định mức giảm trừ gia cảnh (UC04/05/06)
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-10">
        ...
        <section className="xl:col-span-2 space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-black text-slate-900 uppercase tracking-tight italic">
                Biểu thuế <span className="text-primary italic">Lũy tiến</span>
              </h2>
            </div>
            <Button
              variant="outline"
              onClick={handleAddTier}
              className="rounded-xl font-black text-[10px] uppercase gap-2 h-9 border-slate-200"
            >
          ...
          <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-2xl shadow-slate-200/50 overflow-hidden">
            {/* ==============================================
                    KHU VỰC VẼ BẢNG: CẤU HÌNH THUẾ NHÂN VIÊN
                    ============================================== */}
            <table className="w-full text-left">
              <thead>
                <tr className="bg-slate-50/50 border-b border-slate-100">
                  <th className="px-4 py-5 text-[10px] font-black uppercase text-slate-400 tracking-widest text-center w-16 pl-10">
                    Bậc
                  </th>
                  <th className="px-4 py-5 text-[10px] font-black uppercase text-slate-400 tracking-widest">
                    Năm - Trên
                  </th>
                  <th className="px-4 py-5 text-[10px] font-black uppercase text-slate-400 tracking-widest">
                    Năm - Đến
                  ...
                  <th className="px-4 py-5 text-[10px] font-black uppercase text-slate-400 tracking-widest text-center w-24">
                    Thuế (%)
                  </th>
                    ...
                    <td className="px-4 py-4 text-center">
                      <div className="flex items-center gap-1 justify-center">
                        <Input
                          ...
                          onChange={(e) => {
                            const newTiers = [...tiers];
                            newTiers[i].taxRate = Number(e.target.value);
                            setTiers(newTiers);
                          }}
                        />
            ...
            <div className="p-8 bg-slate-50/30 border-t border-slate-100 flex items-center justify-between">
              <p className="text-[10px] text-slate-400 font-bold uppercase italic">
                * Nhập cận trên là 0 để hiểu là không giới hạn (Bậc cao nhất)
              </p>
              <Button
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-black text-slate-900 uppercase tracking-tight italic">
              Giảm trừ <span className="text-orange-500 italic">Gia cảnh</span>
            </h2>
          </div>
          ...
          <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-2xl shadow-slate-200/50 space-y-8">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setDeductions({
                      ...deductions,
                      dependentDeduction: Number(e.target.value),
                    })
                  }
                />
              </div>
            ...
            <div className="p-4 bg-amber-50 border border-amber-100 rounded-2xl flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[9px] text-amber-600/80 font-medium leading-relaxed italic mt-1">
                  Nghị quyết 954/2020/UBTVQH14 điều chỉnh mức giảm trừ gia cảnh
                  lên 11tr cho người nộp thuế và 4.4tr cho mỗi người phụ thuộc.
                </p>
              </div>
            </div>
          </div>
