              ...
              <table className="w-full text-sm text-left border-collapse">
                <thead>
                  <tr className="bg-[#E6F4F1] border-b border-gray-300">
                    <th className="px-4 py-3 font-bold text-black border-r border-gray-300 pl-8">
                      Chức năng hệ thống
                    </th>
                    <th className="px-4 py-3 font-bold text-black border-r border-gray-300 text-center">
                      Admin
                    </th>
                    {EDITABLE_ROLES.map((r) => (
                      <th
                        key={r}
                        className="px-4 py-3 font-bold text-black border-r border-gray-300 text-center"
                      >
                        {ROLE_LABELS[r]}
                      </th>
                    ))}
                ...
                <tbody className="divide-y divide-gray-200">
                  {FUNCTION_CODES.map((fn) => (
                    <tr
                      key={fn}
                      className="hover:bg-[#FFF8E1] transition-colors group"
                    >
          ...
          <div className="bg-white rounded-lg border border-gray-300 shadow-sm overflow-hidden flex flex-col">
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left border-collapse">
                <thead>
                  <tr className="bg-[#E6F4F1] border-b border-gray-300">
                    <th className="px-6 py-3 font-bold text-black border-r border-gray-300 pl-8">
                      Người dùng
                    </th>
                    <th className="px-6 py-3 font-bold text-black border-r border-gray-300">
                      Email liên hệ
                    </th>
                    <th className="px-6 py-3 font-bold text-black border-r border-gray-300">
                      Quyền hạn
                    </th>
                    <th className="px-6 py-3 font-bold text-black text-center pr-8">
                      Thao tác
                    </th>
                  </tr>
                </thead>
                      ...
                      >
                        ...
                        <td className="px-6 py-4 border-r border-gray-200">
                          <div className="flex flex-wrap gap-1.5">
                            {u.roles.map((r) => (
                              <span
                                key={r}
                                className="px-2.5 py-1 rounded bg-gray-100 text-[10px] font-bold text-gray-700 border border-gray-200"
                              >
                                {ROLE_LABELS[r]}
                              </span>
                            ))}
                        ...
                        <td className="px-6 py-4 text-center pr-8">
                          <div className="flex items-center justify-center gap-1.5">
                            <button
                              onClick={() => openEdit(u)}
                              className="p-2 rounded hover:bg-blue-100 text-blue-600 transition-all"
                              title="Chỉnh sửa"
                            >
                              <Edit3 size={16} />
                            </button>
                            <button
                              ...
                              className="p-2 rounded hover:bg-amber-100 text-amber-600 transition-all"
                              title="Đổi mật khẩu"
                            >
                              <Key size={16} />
                            </button>
                            <button
                              ...
                              className="p-2 rounded hover:bg-red-100 text-red-600 transition-all"
                              title="Xóa tài khoản"
                            >
                              <Trash2 size={16} />
                            </button>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300">
            ...
            >
              <div className="flex items-center gap-4 border-b border-gray-200 pb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-black tracking-tight leading-none">
                    {editingUser ? "Cập nhật" : "Tạo mới"} người dùng
                  </h3>
                  <p className="text-[11px] font-medium text-gray-500 mt-1">
                    Vui lòng nhập đầy đủ thông tin hệ thống
                  </p>
                </div>
              </div>
                    ...
                    {roles
                      ...
                      .map((r) => {
                        ...
                        return (
                          ...
                          >
                            <div
                              className={`w-4 h-4 rounded border flex items-center justify-center transition-all ${selected ? "bg-blue-600 border-blue-600" : "border-gray-300"}`}
                            >
                              {selected && (
                                <CheckCircle2
                                  size={12}
              ...
              <div className="flex gap-3 pt-4 border-t border-gray-200 mt-6">
                <Button
                  onClick={handleSave}
                  className="flex-1 h-11 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs uppercase tracking-wider shadow-sm"
                >
                ...
                <Button
                  ...
                  className="px-6 h-11 rounded-lg font-bold text-xs uppercase text-gray-500 hover:bg-gray-100 border border-gray-300"
                >
                  Đóng
                </Button>
              </div>
            ...
            >
              ...
              <div className="flex flex-col gap-2.5 pt-2">
                <Button
                  ...
                  className="h-11 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs uppercase tracking-wider shadow-sm"
                >
                  Xác nhận đổi
                </Button>
                <Button
                  ...
                  className="h-11 rounded-lg font-bold text-xs uppercase text-gray-500 hover:bg-gray-100 border border-gray-300"
                >
                  Hủy bỏ
                </Button>
              </div>
